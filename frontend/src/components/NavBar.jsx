...
export default function Navbar() {
  ...
  return (
    <nav className="relative flex items-center justify-center p-4 bg-gray-800 text-white">
      {/* Site name positioned to the left */}
      ...
      {/* Centered Import and Export buttons */}
      <div className="space-x-4">
        <label className="cursor-pointer bg-blue-600 hover:bg-blue-700 px-3 py-1 rounded">
          Import
          <input
            type="file"
